...
function Home() {
    ...
    const [segment, setSegment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('AWAITING');
    const [reasoning, setReasoning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Waiting for first message…');
    const [objection, setObjection] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('—');
    const [recProduct, setRecProduct] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('—');
    const [nextAction, setNextAction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('—');
    ...
    const [customerId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "Home.useState": ()=>"demo-customer-" + Date.now()
    }["Home.useState"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            checkBackend();
            const loadBrandAndGreet = {
                "Home.useEffect.loadBrandAndGreet": async ()=>{
                    try {
                        const res = await fetch("http://localhost:3001/api/config");
                        const data = await res.json();
                        setConfig(data);
                        const firstTwo = data.catalog.slice(0, 3).map({
                            "Home.useEffect.loadBrandAndGreet.firstTwo": (p)=>p.name
                        }["Home.useEffect.loadBrandAndGreet.firstTwo"]).join(', ');
                        setMessages([
                            {
            ...
            }["Home.useEffect.loadBrandAndGreet"];
            loadBrandAndGreet();
        }
    }["Home.useEffect"], []);
    ...
    const handleSend = async ()=>{
        ...
        try {
            ...
            setMessages((prev)=>[
                    ...prev,
                    {
                        text: '⚠️ Could not reach backend. Is server.js running on port 3001?',
                        who: 'sys'
                    }
                ]);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                id: "brandTitle",
                children: config ? `${config.brandName} — AI Sales Agent` : 'AI Sales & Marketing Agent'
            }, void 0, false, {
                fileName: "[project]/app/page.js",
                lineNumber: 160,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "sub",
                id: "brandSub",
                children: config ? `Live AI sales conversation for ${config.brandName}. Every reply is generated from the real product catalog and policies below.` : 'Real-time customer conversation, intent scoring, and lead classification — powered by your own backend.'
            }, void 0, false, {
                fileName: "[project]/app/page.js",
                lineNumber: 161,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "products-strip",
                id: "productsStrip",
                children: config?.catalog.map((p, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "product-chip",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "icon",
                                children: iconFor(p.name)
                            }, void 0, false, {
                                fileName: "[project]/app/page.js",
                                lineNumber: 170,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: `status-dot ${backendStatus === 'ok' ? 'ok' : backendStatus === 'err' ? 'err' : ''}`,
                                        id: "dot"
                                    }, void 0, false, {
                                        fileName: "[project]/app/page.js",
                                        lineNumber: 212,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        id: "connText",
                                        children: backendStatus === 'ok' ? 'Backend connected · localhost:3001' : backendStatus === 'err' ? 'Backend not reachable — make sure "npm start" is running in the backend folder' : 'Checking backend...'
                                    }, void 0, false, {
                                        fileName: "[project]/app/page.js",
                                        lineNumber: 213,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            segment === 'HOT' ? '🔥 ' : '',
                                            segment === 'AWAITING' ? '— AWAITING —' : segment
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/page.js",
                                        lineNumber: 241,
...
_s(Home, "EiSOcheOIruu/uN842UnWnPPIlU=");
_c = Home;
var _c;
